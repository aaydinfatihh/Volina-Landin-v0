...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-[2] w-full px-11">
        ...
        <Reveal as="p" className="hero-sub">
          Kliniğinin yıllar içinde biriktirdiği ve reklamına para harcadığı ama
          herkesin takip etmeyi bıraktığı binlerce eski leadi satışa çevir.
        </Reveal>
